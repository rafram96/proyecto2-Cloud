  ...
  return (
    <div className=" bg-[#000000] fixed inset-x-0 top-0 h-16 px-8 flex items-center justify-between text-2xl  w-full z-50">
      ...
      <div className="flex gap-8 items-center">
        ...
        <button
          onClick={handleCart}
          className="relative bg-transparent border-none outline-none text-white hover:text-[#FFF0AD] transition duration-300"
        >
          <svg
            className="h-8 w-8 text-white hover:text-[#FFF0AD] transition duration-300"
            width={24}
            height={24}
            viewBox="0 0 24 24"
            strokeWidth={2}
